...
/-! P72 v2: rotating the ternary spine preserves neutral balance. -/
...
theorem every_rotation_is_neutral : rotation0 = 0 ∧ rotation1 = 0 ∧ rotation2 = 0 := by
  constructor
  · exact rotation0_neutral
  constructor
  · exact rotation1_neutral
  · exact rotation2_neutral
